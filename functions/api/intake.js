...
export function validateIntake(body){
 ...
 const allowed=['version','kind','source','campaign','ad','medium','location','storage_use_case','item_description','items','requested_size','requested_sqm','buddy_recommended_size','ai_estimate','desired_move_in','desired_move_in_date','expected_duration','duration','quoted_price','quoted_price_min','quoted_price_max','quoted_sizes','next_step','quoted_size_sqm','price_type','price_version','price_response','budget_thb','readiness_level','phone','line_id','contact_preference','email','entry_point','language','consent_at','consent_version'];
