...
- Complex pricing/matching algorithms; revenue-management SaaS; automatic lease/JV underwriting.
- Custom AI model or training pipeline. Human review first; an interchangeable AI provider interface is allowed within P2.
- Fundraising/investor pages.
- Broader controlled/managed/JV/partner network operations beyond the minimal scaffolds and lead workflows in the MVP.

Promotion into implementation needs a clear near-term customer/research/lead-operation benefit and explicit approval for work beyond P2. Do not expand the build merely because the brand could support more categories.
