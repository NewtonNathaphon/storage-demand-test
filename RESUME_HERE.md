...
September 13: Backoffice now matches CCAQR charcoal/cyan palette, IBM Plex fonts and compact spacing; dark-green theme superseded. Public dropzone darkened, benefits compacted, location marketing updated, FAQ removed, support CTA opens official LINE, registered-address parenthetical removed. Post-registration estimated pricing awaits approved rates for 1/2/3/4/5/8 sqm; do not invent tariffs. Responsive presale and mock contact-card lifecycle checks passed.
