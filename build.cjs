...
for (const name of ['index.html', 'backoffice.html', 'assets/backoffice.js', 'assets/line_official.jpg', 'robots.txt', 'sitemap.xml', '_headers', '_routes.json',
  'assets/buddy_support.png', 'assets/buddy_opening_promo.png', 'assets/buddy_room_advice_v4.png', 'assets/buddy_hero_banner3.png', 'assets/buddy_size_advisor_v2.png', 'assets/home_space.webp', 'assets/business_storage.webp', 'assets/document_storage.webp',
