...
Latest September 15 Demand Validation V2: Newton explicitly authorized TWO changes: main website first-customer messaging and a separate shareable Q&A page at `/register/`. Preserve the familiar visual style. The questionnaire captures use cases, size, move-in, duration, price response (only after approved prices), readiness, and contact details last. Email optional; no company/tax/address intake. Newton is preparing the price list: publish NO example or invented prices until he supplies it. Exact building and real exterior photo remain unconfirmed; use a labelled landmark reference and label generated visuals. See DEMAND_V2_2026-09-15.md. This supersedes the earlier same-day homepage restoration copy/offer checkpoint, not the requirement to keep the two pages separate.

Latest SEO release work: read `SEO_RELEASE_2026-09-14.md` for the retained page network. Its homepage visual/copy changes are superseded by the September 15 correction above.
...
September 12 latest delivery: read `DELIVERY_2026-09-12.md` first. Newton resumed and authorized implementation/deployment. Backoffice is built and uses the existing CCAQR owner password with server-enforced active-owner access. Storage Supabase remains connected. Public phone/email/LINE and the supplied LINE QR are added; real photo-to-enquiry and persisted follow-up tests passed. Historical pause and unbuilt-admin statements below are superseded.

September 12 identity correction: StorageBuddy is the brand, operated by FLOWCRAFT PROCESS SOLUTION CO.,LTD., tax/registration ID 0105568154944. Registered address supplied by Newton: 26-26/2 Charoenrat 7 Yeak 9, Bang Khlo, Bang Kho Laem, Bangkok, Thailand, 10120. Header/footer use the exact supplied `storagebuddy III/logo.png`, copied unchanged to `assets/storagebuddy_logo_original.png`; do not replace it with a generic cube. The older requested `09_17_17 PM.png` filename was absent; `logo.png` and the previous WebP depict the shutter/B/keyhole logo. Footer, privacy, consent and Organization metadata identify the operating company. Browser checks passed at 360/390/768/1440 pixels in Thai and English, including privacy/enquiry dialogs and no JavaScript errors.
...
Current brand: StorageBuddy / สตอเรจบดด. Active site: wife/family Rama 3 building. Core room hypothesis: 2–5 sqm. Rent cases: THB 100k / 150k / 200k monthly. Primary URL: https://storagebuddyth.com. Platform URL: https://getstorage.pages.dev.
